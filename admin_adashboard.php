...
if (!$is_admin && isset($_POST['admin_login'])) {
    ...
    if ($admin_pass === 'admin123') { // Default password - change this!
...
if ($shs_result) $shs_applications = $shs_result->fetch_all(MYSQLI_ASSOC);

$college_result = $conn->query("SELECT *, 'college' as type FROM college_clients ORDER BY id DESC");
if ($college_result) $college_applications = $college_result->fetch_all(MYSQLI_ASSOC);
?>
...
<?php else: ?>
    ...
    <div class="container">
        ...
        <div class="section">
            <h2 class="section-title"><i class='bx bxs-graduation'></i> Senior High School Applications</h2>
            <div class="applications-grid">
                    ...
                    <div class="app-card" data-status="<?= $status ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-value"><?= htmlspecialchars($app['age']) ?></span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">Gender:</span>
                                <span class="info-value"><?= htmlspecialchars($app['gender']) ?></span>
                            </div>
                            <div class="info-row">
                ...
                <?php endforeach; ?>
                <?php if (empty($shs_applications)): ?>
                    <p style="color: #888;">No SHS applications yet.</p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="section">
            <h2 class="section-title"><i class='bx bxs-building'></i> College Applications</h2>
            <div class="applications-grid">
                ...
                <?php endforeach; ?>
                <?php if (empty($college_applications)): ?>
                    <p style="color: #888;">No college applications yet.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
